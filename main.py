	...
	def s(self):
	    while True:
	        try:
	            ...
	            if data != self.h:
	                self.h=data
	                Clock.schedule_once(lambda dt: self.add(data))
	            ...
	            Clock.schedule_once(lambda dt,t=e: toast('SOME ERROR HAPPEN'))   				
	        time.sleep(1)        
	    ...
	    try:
	        ...
	        if isinstance(data,dict):
	            for k,v in data.items():
	                ...
	                l1=MDLabel(text=str(v.get('msg')),adaptive_height=True,theme_text_color='Custom',text_color=(0.07, 0.07, 0.07, 1))
	                c1.add_widget(l1)
	                box.add_widget(c1)
